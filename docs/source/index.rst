...
Usage
#####
 * Download and Install android emulator, base on the guidance `Genymotion <https://www.genymotion.com/>`_ or `Andoroid Emulator <https://github.com/codepath/android_guides/wiki/Installing-Android-SDK-Tools>`_.
